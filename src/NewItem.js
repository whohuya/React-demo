    ...
    <div style={detailStyle}>
      ...
      <div>
        ...
        <p><span>学工号：</span><input type='text'
          style={{width: '70%', height: '30px', border: '0px'}} /></p>
        <p><span>手机号：</span><input type='text'
          style={{width: '70%', height: '30px', border: '0px'}} /></p>
        <button
          style={{
            width: '100%',
